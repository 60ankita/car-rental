<?php
 ...
 $apiKey = "rzp_test_c5ZC1GmnzxzmcN";
...
<script
    ...
    data-description="Web Application"
    data-image="https://www.pinclipart.com/picdir/middle/563-5639396_car-rental-logo-png-clipart.png"
    
    data-prefill.name="<?php echo $_POST['name'];?>"
    data-prefill.email="<?php echo $_POST['email'];?>"
    data-prefill.contact="<?php echo $_POST['mobile'];?>"
    data-theme.color="#11F0D0"
></script>
